...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        HuevoSorpresaGomezMorenoIvan2122 h_sorpresa;
       
        
        h_sorpresa=new HuevoSorpresaGomezMorenoIvan2122(10,5,"peluche",10);
        opera_PrecioGomezMorenoIvan2122(h_sorpresa);
    ...
    public static void opera_PrecioGomezMorenoIvan2122(HuevoSorpresaGomezMorenoIvan2122 h_sorpresa) {
        opera_UnidadesGomezMorenoIvan2122(h_sorpresa);
    }

    public static void opera_UnidadesGomezMorenoIvan2122(HuevoSorpresaGomezMorenoIvan2122 h_sorpresa) {
